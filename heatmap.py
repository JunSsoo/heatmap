...
class HeatmapGenerator(QMainWindow):
    ...
    def load_sample_data(self):
        ...
        data = [
            ['Gochang', 15, 8, 37, 47, 42, 96, 89, 98, 76],
            ['Gwangju', 14, 10, 22, 39, 64, 72, 57, 90, 72],
            ['Namwon', 28, 27, 49, 32, 66, 84, 72, 97, 85],
            ['Damyang', 9, 20, 36, 54, 70, 93, 63, 97, 71],
            ['Boseong', 35, 31, 46, 48, 97, 77, 59, 81, 74],
            ['Suncheon', 51, 66, 85, 57, 75, 82, 97, 99, 99],
            ['Yeonggwang', 7, 6, 22, 36, 78, 75, 56, 81, 66],
            ['Yeongam', 21, 27, 22, 29, 79, 77, 51, 76, 82],
            ['Iksan', 15, 2, 37, 35, 78, 82, 59, 97, 93],
            ['Jeongeup', 12, 2, 17, 2, 88, 77, 33, 95, 80],
            ['Haenam', 54, 44, 83, 62, 77, 91, 71, 99, 91],
